      ...
      <div className='w-80 bg-white shadow-xl rounded-lg'>
        ...
        <h2 className="card-title text-lg font-semibold mb-3">{courseName}</h2>
          ...
          <div className="flex justify-between mb-6">
            <p className="text-base font-medium text-[rgba(28, 27, 27, 0.60)] flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
</svg><span className='ml-1'>Price:{price}</span></p>
            <p className="text-base font-medium text-[rgba(28, 27, 27, 0.60)] flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
</svg><span className='ml-2'> Credit: {creditHours}hr</span></p>
          </div>
